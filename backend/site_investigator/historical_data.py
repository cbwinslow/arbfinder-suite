            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                if first_response.status_code == 200:
                    ...
                    if len(first_data) > 1:  # First row is headers
                        ...
                        results["first_snapshot"] = self._parse_timestamp(
                            first_snapshot[1]
                        )
                ...
                if last_response.status_code == 200:
                    ...
                    if len(last_data) > 1:
                        ...
                        results["last_snapshot"] = self._parse_timestamp(
                            last_snapshot[1]
                        )
                    ...
                    for row in data[1:]:
                        if len(row) >= 5:
                            snapshot = {
                                ...
                                "mimetype": row[3],
                                "statuscode": row[4],
                                "wayback_url": self._build_wayback_url(
                                    row[1], row[2]
                                ),
                            }
        ...
        for i, snapshot in enumerate(snapshots):
            try:
                ...
                if content:
                    ...
                    price_data = self._extract_price_from_html(
                ...
                async with httpx.AsyncClient(timeout=15.0) as client:
                    ...
                    if response.status_code == 200:
                        ...
                        if (
                            ...
                            and data["archived_snapshots"].get("closest")
                        ):
