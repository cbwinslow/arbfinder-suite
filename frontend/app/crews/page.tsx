    ...
    <main className="mx-auto max-w-7xl p-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-2">
            Run Crawl4AI/CrewAI agents for data ingestion and processing
          </p>
        </div>
      ...
      <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
        ...
        <p className="text-gray-300 text-sm">
          AI crews are coordinated groups of specialized AI agents that work
          together to accomplish complex tasks. Each crew type has multiple
          agents with specific roles (crawler, validator, enricher, etc.) that
          collaborate to ingest price data, enrich metadata, generate listings,
          or perform market research. Select a crew type, configure the targets
          and query, then let the AI agents do the work!
        </p>
      </div>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span
                        className={`text-xs font-semibold px-2 py-1 rounded border ${getStatusColor(run.status)}`}
                      >
